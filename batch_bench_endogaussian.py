...
def run_bench_fps(repo_root: Path, exp: Path, iteration: int, split="test", views=1, warmup=10, iters=200):
    ...
    try:
        ...
        (exp / "bench_fps_error.log").write_text(e.output or "", encoding="utf-8", errors="ignore")
        return None
    ...
    try:
        ...
        (exp / "bench_fps_output.log").write_text(out, encoding="utf-8", errors="ignore")
        return None
